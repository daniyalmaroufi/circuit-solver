...
def getShowResultAns(circuit):
    ...
    for i in range(1, len(circuit.nodes)):
        ...
        result += '&nbsp;&nbsp;Voltage: ' +str(round(circuit.nodes[i].volt,4)) + ' V<br>'

    for indVolt in circuit.indVolt:
        result += 'Battery: '
        result += '&nbsp;&nbsp;posTerm, negTerm: ' + str(indVolt.PosTerm) + ', ' + str(indVolt.NegTerm) + '<br>'
        result += '&nbsp;&nbsp;&nbsp;Voltage: ' + str(round(indVolt.Voltage,4)) + ' V<br>'
        result += '&nbsp;&nbsp;&nbsp;current: ' + str(round(indVolt.Current,4)) + ' A<br><br>'

    for res in circuit.resistors:
        result += "Resistor:"
        result += "&nbsp;&nbsp;Left, Right: " + str(res.leftNode) + ', ' + str(res.rightNode) + '<br>'
        result += '&nbsp;&nbsp;&nbsp;resistance: ' + str(res.Resistance) + ' ohm<br>'
        result += '&nbsp;&nbsp;&nbsp;voltage: ' + str(round(res.Voltage,4)) + ' V<br>'
        result += '&nbsp;&nbsp;&nbsp;current: ' + str(round(res.Current,4)) + ' A<br><br>'
